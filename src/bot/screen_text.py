...
SCREEN_TEXT_PLACEHOLDERS: dict[str, list[tuple[str, str]]] = {
    ...
    "subscription": _pl("имя", "id", "подписка", "срок", "осталось", "устройств", "трафик",
                        "автопродление", "баланс"),
...
SCREEN_TEXT_DEFAULTS: dict[str, str] = {
    ...
    "balance": (
        ...
        "\n"
        "Пополни через Telegram Stars — с баланса подписка оплачивается в один тап."
    ),
    "referral": (
