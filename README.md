...
| 💠 | Tribute / FreeKassa / CloudPayments / … | ещё 12 в каталоге | 🔌 drop-in, файл на кассу |

Как это выглядит для юзера: включил провайдера в кабинете (ключи шифруются,
...
одним файлом ([гайд](.claude/skills/add-payment-gateway/SKILL.md)). У каждого —
